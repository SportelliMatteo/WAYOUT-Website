...
class ProductionCheck extends Command
{
    ...
    public function handle(): int
    {
        $checks = [
            ...
            ['Stripe live configurato', Str::startsWith((string) config('services.stripe.key'), 'pk_live_') && Str::startsWith((string) config('services.stripe.secret'), 'sk_live_')],
            ['Webhook Stripe configurato', Str::startsWith((string) config('services.stripe.webhook_secret'), 'whsec_')],
