...
<section class="py-10 lg:py-16">
    <div class="wayout-shell">
        ...
        <div class="mt-8 grid gap-6 lg:grid-cols-[0.72fr_0.28fr] lg:items-start">
            <article class="wayout-panel min-w-0 rounded-[1.5rem] p-5 leading-7 text-slate-700 sm:p-8">
                @yield('legal-content')
            </article>
            ...
            <aside class="rounded-lg border border-slate-200 bg-white p-4 shadow-sm lg:sticky lg:top-28">
                ...
                <nav class="mt-4 flex flex-col gap-2 text-sm font-black">
                    ...
                    <a class="rounded-lg px-3 py-2 transition hover:bg-violet-50 hover:text-violet-700 {{ request()->routeIs('legal.terms') ? 'bg-slate-950 text-white hover:bg-slate-950 hover:text-white' : 'text-slate-600' }}" href="{{ route('legal.terms') }}">Termini sito e waitlist</a>
                    ...
                    <a class="rounded-lg px-3 py-2 transition hover:bg-violet-50 hover:text-violet-700 {{ request()->routeIs('legal.sales') ? 'bg-slate-950 text-white hover:bg-slate-950 hover:text-white' : 'text-slate-600' }}" href="{{ route('legal.sales') }}">Termini di vendita</a>
                    <a class="rounded-lg px-3 py-2 transition hover:bg-violet-50 hover:text-violet-700 {{ request()->routeIs('legal.presale') ? 'bg-slate-950 text-white hover:bg-slate-950 hover:text-white' : 'text-slate-600' }}" href="{{ route('legal.presale') }}">Condizioni di pre-sale</a>
                    <a class="rounded-lg px-3 py-2 transition hover:bg-violet-50 hover:text-violet-700 {{ request()->routeIs('legal.refunds', 'withdrawal.*') ? 'bg-slate-950 text-white hover:bg-slate-950 hover:text-white' : 'text-slate-600' }}" href="{{ route('legal.refunds') }}">Recesso e rimborsi</a>
