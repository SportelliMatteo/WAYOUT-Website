...
<div class="space-y-8">
    <section>
        ...
        <p class="mt-3">Questa informativa riguarda il sito wayoutapp.it, la waitlist, la pre-sale dei Founder Pass, il checkout, i form di contatto e le relative comunicazioni. Non disciplina i trattamenti effettuati tramite l’app WAYOUT dopo il lancio, che saranno descritti in una specifica informativa privacy dell’app.</p>
    </section>
    ...
    <section>
        ...
        <ul class="mt-3 list-disc space-y-2 pl-6">
            <li>dati della waitlist: indirizzo email e scelta relativa al consenso marketing; la waitlist non richiede nome, cognome, data di nascita o numero di telefono;</li>
            <li>scelta relativa al consenso marketing, che è facoltativa e separata dall’iscrizione alla waitlist;</li>
            <li>dati del checkout, dell’account e dell’acquisto: Founder Pass selezionato, nome, cognome, data di nascita, genere, numero di telefono verificato, identificativo account WAYOUT e nickname generato automaticamente; se viene richiesta fattura, anche tipologia cliente, codice fiscale oppure ragione sociale e Partita IVA, indirizzo, CAP, Comune, Provincia, Stato, PEC e codice destinatario SDI ove applicabili;</li>
        ...
        <ul class="mt-3 list-disc space-y-2 pl-6">
            <li>data e ora della richiesta e della verifica email, identificativi interni, token di verifica conservato in forma hash fino alla scadenza/uso, posizione waitlist, stato dell’offerta e informazioni necessarie a gestire il limite dei posti disponibili;</li>
            <li>piano selezionato, codice del pacchetto promozionale, importo, valuta, stato dell’ordine o del pagamento, numero o identificativo interno dell’acquisto, identificativo account WAYOUT, identificativo della sessione Stripe e dati tecnici necessari alla verifica dell’entitlement;</li>
            <li>evidenze relative alla presa visione delle informative, ai consensi e alle condizioni accettate, quali data, ora, fonte, versione/hash dei documenti, indirizzo IP, user agent e identificativo di sessione in forma hash, nei limiti necessari a documentare la scelta e prevenire abusi;</li>
    ...
    <section>
        ...
        <p class="mt-3"><strong>Conservazione: </strong>I dati di sessione sono conservati per la durata tecnica configurata. I log tecnici ordinari sono conservati, di regola, per 30 giorni. I log di sicurezza e amministrativi possono essere conservati fino a 12 mesi; per gli accessi degli eventuali amministratori di sistema è assicurata una conservazione non inferiore a 6 mesi, ove applicabile. I dati possono essere conservati più a lungo quando ciò sia necessario per gestire incidenti, abusi, contenziosi o richieste delle autorità.</p>
        ...
        <p class="mt-3"><strong>Dati trattati: </strong>Email, timestamp, identificativo e stato dell’iscrizione, token di verifica in forma hash, data/ora di verifica, posizione waitlist, stato dell’offerta e consenso marketing se espresso.</p>
        <p class="mt-3"><strong>Finalità: </strong>Registrare la richiesta, verificare il controllo dell’indirizzo email mediante magic link, assegnare la posizione solo dopo la verifica, gestire il limite degli utenti validi e rendere possibile l’eventuale attribuzione del Waitlist Pass secondo le condizioni applicabili.</p>
        ...
        <p class="mt-3"><strong>Conferimento: </strong>L’indirizzo email e l’accettazione dei Termini waitlist sono necessari per completare l’iscrizione. Il consenso marketing è facoltativo e non condiziona la posizione o l’accesso alle offerte.</p>
        <h3 class="mt-6 text-xl font-black text-slate-900">4.3 Verifica della maggiore età, del telefono e creazione/riconoscimento account</h3>
        <p class="mt-3"><strong>Dati trattati: </strong>Nome, cognome, data di nascita ed esito 18+, genere, prefisso e numero di telefono, OTP/token Firebase trattati temporaneamente, identificativo account e nickname generato automaticamente.</p>
        <p class="mt-3"><strong>Finalità: </strong>Verificare che l’acquirente sia maggiorenne, verificare il numero di telefono, prevenire abusi e creare o riconoscere l’account WAYOUT necessario a collegare il Founder Pass. Tali operazioni avvengono nel checkout e non nel form waitlist.</p>
        ...
        <p class="mt-3"><strong>Dati trattati: </strong>Email e informazioni relative alla verifica dell’iscrizione, alla posizione e all’idoneità al Waitlist Pass.</p>
        ...
        <p class="mt-3"><strong>Dati trattati: </strong>Email, consenso marketing e relative evidenze; dati tecnici relativi a invio, consegna, rimbalzo e disiscrizione delle comunicazioni gestite tramite Brevo. Il tracciamento individuale di aperture e clic è disattivato alla data di questa versione.</p>
        ...
        <p class="mt-3"><strong>Dati trattati: </strong>Identificativi online e cookie, indirizzo IP, dati del browser e del dispositivo, area geografica approssimativa, URL e pagina visualizzata, referrer, eventi di navigazione, interazioni con i contenuti, conversioni e dati relativi alle campagne. Gli strumenti previsti sono Google Tag Manager, Google Analytics 4 e Meta Pixel lato browser e, quando configurata, la Conversions API lato server.</p>
    ...
    <section>
        ...
        <ul class="mt-3 list-disc space-y-2 pl-6">
            ...
            <li>Aruba e gli eventuali soggetti coinvolti nell’hosting, nell’infrastruttura, nel database, nei backup, nei log e nella sicurezza del sito. L’infrastruttura di hosting scelta da WAYOUT è localizzata all’interno dell’Unione europea;</li>
            ...
            <li>Google, per Google Tag Manager e Google Analytics 4, e Meta Platforms, per Meta Pixel e Conversions API, esclusivamente dopo il consenso pertinente e secondo i rispettivi ruoli privacy;</li>
    ...
    <section>
        ...
        <p class="mt-3">L’hosting principale del sito utilizza Aruba con database MySQL. Brevo è utilizzato per le comunicazioni email; Google/Firebase per verifica telefonica, reCAPTCHA e, previo consenso, analytics; Meta, previo consenso, per misurazione marketing; Stripe per i pagamenti e Qonto per la fatturazione elettronica. Alcuni di tali fornitori o subfornitori possono trattare o rendere accessibili dati anche al di fuori dello Spazio Economico Europeo secondo il proprio assetto contrattuale.</p>
    ...
    <section>
        ...
        <p class="mt-3">WAYOUT utilizza controlli automatizzati di disponibilità del pacchetto, idoneità all’acquisto, maggiore età, verifica telefonica, stato del pagamento ed entitlement. Tali controlli sono finalizzati a eseguire il contratto, prevenire abusi e impedire acquisti non validi e, secondo l’assetto attuale, non sono destinati a produrre decisioni unicamente automatizzate con effetti giuridici o analogamente significativi ai sensi dell’articolo 22 GDPR. In caso di esito anomalo l’utente può contattare <a class="font-black text-violet-700" href="mailto:amministrazione@wayoutapp.it">amministrazione@wayoutapp.it</a> per una verifica. Stripe può inoltre utilizzare propri sistemi antifrode secondo la relativa informativa.</p>
    </section>

    <section>
        <h2 class="text-2xl font-black text-slate-950">12. Utenti minorenni</h2>
        <p class="mt-3">Il servizio WAYOUT e la pre-sale sono riservati a utenti di almeno 18 anni. Il form waitlist non raccoglie la data di nascita; il requisito viene verificato nel checkout e nei successivi flussi di account/attivazione. Qualora WAYOUT venga a conoscenza di dati riferiti a un minorenne in violazione delle condizioni applicabili, adotterà misure ragionevoli per cancellarli o limitarne il trattamento, salvo obblighi di legge o necessità di tutela.</p>
    </section>
